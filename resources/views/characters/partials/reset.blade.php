        ...
        <div>
            ...
            <div class="space-y-2">
                ...
                @if ($character->trainingMonths < $character->background->adjustedMonths)
                    <p><strong><em>{{ __('Your character has been built with less than the current amount of training months. Resetting will allow you to use those extra months.') }}</em></strong></p>
                @endif
            </div>
        </div>
    </div>
