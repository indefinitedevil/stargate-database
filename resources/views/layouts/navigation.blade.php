@php
    ...
    use App\Models\User;
@endphp
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 sm:grid sm:grid-cols-6">
    <!-- Primary Navigation Menu -->
    <div class="sm:col-span-4 sm:col-start-2 px-4 sm:px-6 lg:px-8">
