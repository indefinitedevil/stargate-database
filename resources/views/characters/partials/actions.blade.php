...
<div class="sm:float-right grid grid-cols-2 sm:flex gap-4 sm:gap-1 mb-6">
    @can('edit', $character)
        ...
        @endif
        @if(!$character->isPrimary && in_array($character->status_id, [Status::APPROVED, Status::PLAYED]))
    ...
    ><i class="fa-regular fa-rectangle-list"></i><span class="sm:hidden"> {{ __('Print Skills') }}</span></a>
</div>
