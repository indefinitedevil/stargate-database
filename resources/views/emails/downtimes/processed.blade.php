...
({{ __('Vigour :change', ['change' => add_positive_modifier($result['vigor_change'])]) }})
@endif
...
({{ __('Vigour :change for next event', ['change' => add_positive_modifier($result['temp_vigor_change'])]) }})
@endif
</li>
@endforeach
</ul>
